...
static Character CreateScorpion() {
	...
	Movement punchUpMultMov = Movement{ punchUpMult, Vector2<float>(0.0, 0.0),{98*3,106*3,108*3,109*3,107*3,110*3,105*3,106*3,106*3,99*3},{52*3,50*3,51*3,48*3,48*3,48*3,48*3,48*3,49*3,51*3},
		{0,0,135*3,0,0,133*3,0,0,0,0},{0,0,57*3,0,0,54*3,0,0,0,0} };
	...
	Movement kickMov = Movement{ kick, Vector2<float>(0.0, 0.0), {87*3,89*3,86*3,95*3,88*3,89*3,80*3},{53*3,46*3,63*3,80*3,64*3,46*3,51*3},
		{0,0,0,142*3,0,0,0},{0,0,0,75*3,0,0,0} };
	...
	Movement kickDownMov = Movement{ kickDown, Vector2<float>(0.0, 0.0), {84*3,80*3,80*3,79*3,79*3,93*3,96*3,81*3},{95*3,117*3,119*3,122*3,123*3,118*3,103*3,62*3},
		{0,0,0,0,134*3,0,0,0},{0,0,0,0,144*3,0,0,0} };
	...
	Vector2f punchD[5] = { {0,0},{0,0},{45 * 3,20 * 3},{0,0},{0,0} };
	Vector2f punchUpD[5] = { {0,0},{0,0},{47 * 3,24 * 3},{0,0},{0,0} };
	Vector2f punchDownD[5] = { {0,0},{0,0},{45 * 3,28 * 3},{0,0},{0,0} };
	Vector2f punchFromUpD[5] = { {0,0},{0,0},{42 * 3,35 * 3},{0,0},{0,0} };
	Vector2f bodyToBodyD[5] = { {0,0},{0,0},{21 * 3,30 * 3},{0,0},{0,0} };
	Vector2f punchMultD[10] = { {0,0},{0,0},{47 * 3,20 * 3},{0,0},{0,0},{55 * 3,20 * 3},{0,0},{0,0},{0,0},{0,0} };
	Vector2f punchMultUpD[10] = { {0,0},{0,0},{49 * 3,24 * 3},{0,0},{0,0},{48 * 3,26 * 3},{0,0},{0,0},{0,0},{0,0} };

	Vector2f kickD[7] = { {0,0},{0,0},{0,0},{63 * 3,27 * 3},{0,0},{0,0},{0,0} };
	Vector2f kickUpD[8] = { {0,0},{0,0},{0,0},{20 * 3,34 * 3},{0,0},{0,0},{0,0},{0,0} };
	Vector2f kickDownD[8] = { {0,0},{0,0},{0,0},{0,0},{54 * 3,51 * 3},{0,0},{0,0},{0,0} };
	Vector2f kickFromDownD[5] = { {0,0},{0,0},{59 * 3,44 * 3},{0,0},{0,0} };
	Vector2f kickFromUpD[3] = { {0,0},{52*3,31*3},{0,0} };
