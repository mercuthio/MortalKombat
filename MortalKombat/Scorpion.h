...
static Character CreateScorpion() {
	...
	Animation kickUp0 = Animation(7, spriteSheet, Vector2<int>(2606, 2046), sz, 5, false, true, noRecovery, null_vector, 2);
	...
	Animation kickFromUp0 = Animation(3, spriteSheet, Vector2<int>(1904, 3090), sz, 5, false, true, noRecovery, punchOrKickAir_lock, 2);
	...
	Animation blockDown0 = Animation(3, spriteSheet, Vector2<int>(1436, 6122), sz, 5, false, true, noRecovery, blockDown_lock, 2);

	Animation special0 = Animation(7, spriteSheet, Vector2<int>(32, 6644), sz, 5, false, true, noRecovery, null_vector, 2);
	...
	Animation getCaught0 = Animation(7, spriteSheet, Vector2<int>(1670, 5600), sz, 5, false, true, noRecovery, null_vector, 2);
	Animation catch0 = Animation(6, spriteSheet, Vector2<int>(32, 5600), sz, 5, false, true, noRecovery, null_vector, 2);
	...
	Character Scorpion = Character(animations, body, shadow, hitboxes);
