...
extern Keyboard::Key backButton_auxP2;
...
const int life_PUNCH = 3;
const int life_PUNCH_MULTIPLE = 3;
const int life_PUNCH_CLOSE = 3;
const int life_PUNCH_UPPER = 4;
const int life_PUNCH_UPPER_MULTIPLE = 4;
const int life_PUNCH_UPPER_CLOSE = 2;
const int life_PUNCH_FROM_DOWN = 10;
const int life_PUNCH_FROM_AIR = 4;
